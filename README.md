...
- **`openkms-skill/`** — Optional Agent Skill + Python CLI for agents calling the public HTTP API (personal API keys in the app under **Settings**; see **`docs/features/openkms-skill.md`**)
