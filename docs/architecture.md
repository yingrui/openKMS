...
flowchart TB
  subgraph Frontend["Frontend (React/Vite)"]
    FE["Home, Taxonomy, Documents, Articles, Knowledge Bases, Wiki Spaces, Glossaries, Pipelines, Jobs, Models"]
  end
