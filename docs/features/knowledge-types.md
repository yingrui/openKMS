...
| Images (habitus, slides, labels) | Visual evidence linked to taxon/specimen | **Media asset** in a media channel; optional wiki embeds | [Media library](media.md), [Wiki spaces](wiki-spaces.md) | Typed **media evidence** links (specimen ↔ image) beyond generic metadata |
