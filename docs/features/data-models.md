...
- `id` (skill slug, PK), `display_name`, `created_by`, `created_by_name`, `is_default` (auto-install on new project), `default_version` (nullable; used when installing without a version), `created_at`
