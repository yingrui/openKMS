...
| Objects list | ✅ | User-facing list at `/objects`; dataset-backed types from Neo4j when indexed, else dataset SQL; types without a dataset from `object_instances` (Action writes) |
