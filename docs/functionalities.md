...
| [App Builder & Apps](features/app-builder.md) | Platform app authoring: resources + multi-artifact a2ui primitives (module lane reserved); versioned publish/rollback + settings; publish/run in Apps |
