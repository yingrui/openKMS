...
| UI | ✅ | `/wikis`, `/wikis/:id`, `/wikis/:id/pages/:pageId`; wiki space detail: paginated **Pages** list (25 per page), **Import folder** / **Import zip**; sidebar **Wiki Spaces** when toggle + path allowed; preview uses `react-markdown` with `/api/...` image URL resolution |
