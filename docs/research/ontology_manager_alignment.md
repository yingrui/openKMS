...
| entity-view | Function detail left nav + tabs | Complex entities need stable detail shell | Manager Function/Action detail |
...
| Manager resource nav | OT / LT / Functions / Actions | Palantir Resources pattern | ManagerNavRail |
