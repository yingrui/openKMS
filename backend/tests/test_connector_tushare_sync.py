...
from app.services.connector_sync.tushare.sync import _resolve_tushare_windows, _sync_settings
...
def test_sync_settings_defaults():
    ...
    assert cfg["api_min_interval_seconds"] == 61.0
    assert cfg["trade_cal_min_interval_seconds"] == 3661.0
