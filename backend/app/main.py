...
from app.api.media_channels import router as media_channels_router
...
from app.api.app_builder import router as app_builder_router
...
app.include_router(media_channels_router, prefix="/api")
