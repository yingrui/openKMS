...
Mirrors openkms-cli page_index logic for consistency.
"""
...
def md_to_tree_from_markdown(markdown: str, doc_name: str = "document") -> dict[str, Any]:
    """
    Convert markdown string to PageIndex-compatible tree structure.
    Uses # headings for hierarchy: # = level 1, ## = level 2, ### = level 3, etc.
