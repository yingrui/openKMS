...
FRONTEND_FEATURES: list[dict[str, Any]] = [
    ...
    {"path_pattern": "/agents", "label": "Agents (projects list)", "section": "Content", "note": "Feature toggle: agents; projects:read/write"},
    {"path_pattern": "/agents/*", "label": "Agents legacy paths", "section": "Content", "note": "Feature toggle: agents; redirects to /projects/*"},
    {"path_pattern": "/projects/*", "label": "Agent project workspace", "section": "Content", "note": "Feature toggle: agents; projects:read/write"},
