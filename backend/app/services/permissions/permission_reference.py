...
FRONTEND_FEATURES: list[dict[str, Any]] = [
    ...
    {"path_pattern": "/agents", "label": "Agents (projects list)", "section": "Agents", "note": "Feature toggle: agents; projects:read/write"},
    {"path_pattern": "/agents/skills", "label": "Agents · Skills registry", "section": "Agents", "note": "Feature toggle: agents; projects:read/write"},
    {"path_pattern": "/agents/skills/*", "label": "Agents · Skill settings", "section": "Agents", "note": "Feature toggle: agents; projects:read/write"},
    {"path_pattern": "/agents/*", "label": "Agents subtree", "section": "Agents", "note": "Feature toggle: agents; projects:read/write"},
    {"path_pattern": "/projects/*", "label": "Agent project workspace", "section": "Agents", "note": "Feature toggle: agents; projects:read/write"},
