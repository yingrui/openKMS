...
DEFAULT_PATTERNS_BY_KEY: dict[str, tuple[list[str], list[str]]] = {
    ...
    PERM_ONTOLOGY_READ: (
        ...
        [
            ...
            "POST /api/ontology/functions/*/execute",
            "POST /api/ontology/functions/by-api-name/*/execute",
            "POST /api/ontology/action-types/*/execute",
            "GET /api/app-builder/apps",
            "HEAD /api/app-builder/apps",
            "GET /api/app-builder/apps/*",
            "HEAD /api/app-builder/apps/*",
        ],
    ),
    PERM_ONTOLOGY_WRITE: (
        ...
        [
            ...
            "PATCH /api/ontology/functions/*",
            "DELETE /api/ontology/functions/*",
            "POST /api/ontology/functions/*/versions",
            "POST /api/ontology/functions/*/publish",
            "POST /api/ontology/functions/*/validate",
            "POST /api/ontology/functions/*/execute",
            "POST /api/ontology/groups",
            "PATCH /api/ontology/groups/*",
            "DELETE /api/ontology/groups/*",
            "POST /api/ontology/action-types",
            "PATCH /api/ontology/action-types/*",
            "DELETE /api/ontology/action-types/*",
            "POST /api/app-builder/apps",
            "PATCH /api/app-builder/apps/*",
            "DELETE /api/app-builder/apps/*",
            "POST /api/app-builder/apps/*",
        ],
    ),
    PERM_KNOWLEDGE_MAP_READ: (
